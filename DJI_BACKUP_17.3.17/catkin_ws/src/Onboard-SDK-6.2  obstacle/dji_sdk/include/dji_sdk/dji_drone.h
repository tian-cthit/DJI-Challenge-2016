...
private:
    ...
    ros::Subscriber obstacle_distance_subscriber;   //obstacle
    ros::Subscriber ultrasonic_subscriber;	    //ultransonic
...
public:
    ...
    sensor_msgs::LaserScan obstacle_distance;  //ob
    sensor_msgs::LaserScan ultrasonic;          //ul
...
private:
	...
	void obstacle_distance_subscriber_callback(sensor_msgs::LaserScan g_oa)    //ob
	{ 
		obstacle_distance.ranges.resize(5);
		this->obstacle_distance = g_oa;
	}

	void ultrasonic_subscriber_callback(sensor_msgs::LaserScan g_ul)   //ul
	{
...
public:
	...
	obstacle_distance_subscriber = nh.subscribe<sensor_msgs::LaserScan>("/guidance/obstacle_distance", 1, &DJIDrone::obstacle_distance_subscriber_callback, this);    //ob

        ultrasonic_subscriber = nh.subscribe<sensor_msgs::LaserScan>("/guidance/ultrasonic", 1, &DJIDrone::ultrasonic_subscriber_callback, this);//ul

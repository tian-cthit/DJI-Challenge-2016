...
(cl:defmethod yawAngle-val ((m <VelocityControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dji_sdk-srv:yawAngle-val is deprecated.  Use dji_sdk-srv:yawAngle instead.")
  (yawAngle m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<VelocityControl-request>)))
  ...
  "9c3bbb45ca07323b20171c4611835f29")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'VelocityControl-request)))
  "Returns md5sum for a message object of type 'VelocityControl-request"
  "9c3bbb45ca07323b20171c4611835f29")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<VelocityControl-request>)))
  ...
  (cl:format cl:nil "uint8 frame~%float32 vx~%float32 vy~%float32 vz~%float32 yawAngle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'VelocityControl-request)))
  "Returns full string definition for message of type 'VelocityControl-request"
  (cl:format cl:nil "uint8 frame~%float32 vx~%float32 vy~%float32 vz~%float32 yawAngle~%~%~%"))
